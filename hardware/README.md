...
| This project's ESPHome firmware | Source only — **no pre-built binaries are published** (an ESPHome binary carries the whole configuration it was compiled with). Build it from this repo: see [Getting started](https://github.com/byjaps/esp32-max35-tv#getting-started) |
